  ...
  return (
    <div className="grid grid-cols-12 gap-8">
      ...
      <div className="col-span-12 mb-4">
        ...
        <h2 className="text-xs font-medium uppercase tracking-widest text-on-surface-variant opacity-70">
          Gestão de Lotes e Verificação da Cadeia em Tempo Real
        </h2>
      </div>
      ...
      <div className="col-span-12 space-y-8 lg:col-span-7">
        ...
        <section className="relative overflow-hidden rounded-lg bg-surface-container-low p-8">
          ...
          <h2 className="mb-6 flex items-center gap-2 text-xl font-bold text-primary">
            <Factory size={20} /> REGISTRO DE NOVO LOTE
          </h2>
          <form className="grid grid-cols-2 gap-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <select className="w-full rounded-md border-none bg-background p-4 text-on-surface focus:ring-2 focus:ring-primary-container">
                <option>Querosene de Aviação (K-40)</option>
                <option>Diesel Marítimo (M-80)</option>
                <option>Lubrificante Industrial (L-12)</option>
              </select>
            </div>
            <div className="col-span-2 md:col-span-1">
              <label className="mb-2 block text-xs font-bold uppercase tracking-tighter text-on-surface-variant">
              ...
              <input 
                ...
                placeholder="Terminal 7 - Costa Norte" 
              />
            </div>
            <div className="col-span-2 md:col-span-1">
              <label className="mb-2 block text-xs font-bold uppercase tracking-tighter text-on-surface-variant">
              ...
              <div className="relative">
                <input 
                  ...
                  type="number" 
                />
                <span className="absolute right-4 top-1/2 -translate-y-1/2 font-bold text-primary">TM</span>
              </div>
            </div>
            <div className="col-span-2 pt-4">
              <button className="flex w-full items-center justify-center gap-3 bg-primary-container py-4 font-black uppercase tracking-widest text-white transition-all hover:bg-red-700 active:scale-[0.98]">
                <Lock size={18} /> EXECUTAR ENTRADA NO LEDGER
              </button>
            </div>
          </form>
        </section>
        ...
        <section className="overflow-hidden rounded-lg border border-white/5 bg-surface-container-low">
          <div className="flex items-end justify-between border-b border-white/5 p-6">
            <div>
              <h2 className="text-xl font-bold uppercase tracking-tight text-on-surface">Transporte Ativo</h2>
              <p className="text-xs text-on-surface-variant">Telemetria de Satélite ao Vivo • Lote #A722-X</p>
            </div>
            ...
            <div className="pointer-events-none absolute inset-0 flex flex-col justify-between p-6">
              <div className="flex justify-between">
                <div className="pointer-events-auto rounded-lg border border-white/10 bg-black/60 p-3 backdrop-blur-md">
                  <div className="mb-1 text-[10px] font-bold uppercase text-neutral-400">Coordenadas Atuais</div>
                  <div className="font-mono text-sm text-primary">51.9225° N, 4.4792° E</div>
                </div>
                <div className="pointer-events-auto rounded-lg border border-white/10 bg-black/60 p-3 backdrop-blur-md">
                  <div className="mb-1 text-[10px] font-bold uppercase text-neutral-400">Chegada Estimada</div>
              ...
              <div className="flex items-center gap-4">
                <div className="pointer-events-auto flex-1 rounded-lg border border-primary/20 bg-black/80 p-4 backdrop-blur-xl">
                  <div className="mb-2 flex items-center justify-between">
                    <span className="text-xs font-bold uppercase tracking-widest text-primary">ID do Veículo: TANKER_SIGMA_7</span>
      ...
      <div className="col-span-12 space-y-8 lg:col-span-5">
        ...
        <section className="rounded-lg bg-surface-container-low p-8">
          <h2 className="mb-6 text-xl font-bold uppercase tracking-tight text-on-surface">Centro de Comando de Status</h2>
          <div className="space-y-4">
            <label className="mb-4 block text-xs font-bold uppercase tracking-widest text-on-surface-variant">Selecionar Lote Alvo</label>
            <div className="space-y-3">
              <div className="cursor-pointer border-l-4 border-primary/40 bg-surface-high p-4 transition-all hover:border-primary">
                <div className="mb-2 flex items-start justify-between">
                  ...
                  <span className="bg-primary-container px-2 py-0.5 font-mono text-[10px] text-white uppercase">Em Trânsito</span>
                </div>
                <div className="flex items-center gap-2 text-xs text-on-surface-variant">
                  <Droplets size={14} /> 2.800 TM • Combustível de Aviação
                </div>
              </div>
              <div className="cursor-pointer border-l-4 border-transparent bg-background p-4 opacity-60 transition-all hover:border-white/20">
                <div className="mb-2 flex items-start justify-between">
                  ...
                  <span className="bg-neutral-800 px-2 py-0.5 font-mono text-[10px] text-neutral-400 uppercase">Preparado</span>
                </div>
                <div className="flex items-center gap-2 text-xs text-on-surface-variant">
                  <Droplets size={14} /> 1.150 TM • Diesel Marítimo
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 pt-6">
              {[
                { icon: Truck, label: 'Mover para Transporte' },
                { icon: Warehouse, label: 'Chegou ao Armazenamento' },
                { icon: ShieldCheck, label: 'Qualidade Aprovada' },
                { icon: AlertCircle, label: 'Registrar Incidente' },
              ].map((btn) => (
        ...
        <section className="relative overflow-hidden rounded-lg bg-primary-container p-8 text-white">
          ...
          <h2 className="mb-4 flex items-center gap-2 text-xl font-bold uppercase tracking-tighter">
            <ShieldCheck size={20} /> ASSINATURA DIGITAL
          </h2>
          <p className="mb-6 text-sm font-medium opacity-80">
            Verifique a conclusão da transferência do lote #B7219-DELTA e registre a assinatura criptográfica no ledger.
          </p>
          <div className="group relative mb-6 flex h-40 cursor-crosshair flex-col items-center justify-center rounded border border-white/10 bg-black/20">
            ...
            <div className="mt-2 text-[10px] font-bold uppercase tracking-widest opacity-40">Desenhe a Assinatura do Operador Aqui</div>
          ...
          <div className="mt-6 flex items-center gap-3">
            ...
            />
            <div>
              <div className="text-xs font-bold uppercase tracking-tight">Operador: Marcus Thorne</div>
              <div className="text-[10px] opacity-70">ID de Certificação: #IE-4492-X</div>
            </div>
          </div>
        </section>
        ...
        <section className="grid grid-cols-2 gap-4 rounded-lg border border-white/5 bg-surface-high p-6">
          <div className="rounded bg-surface-low p-4">
            <div className="mb-1 text-[10px] font-bold uppercase tracking-widest text-on-surface-variant">Carga Global</div>
          ...
          <div className="rounded bg-surface-low p-4">
            <div className="mb-1 text-[10px] font-bold uppercase tracking-widest text-on-surface-variant">Frota Ativa</div>
            <div className="font-headline text-2xl font-bold text-on-surface">12 / 14</div>
            <div className="mt-2 font-mono text-[10px] text-primary">+2 Sincronizando</div>
          </div>
        </section>
      </div>
    </div>
