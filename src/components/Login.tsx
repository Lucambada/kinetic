      ...
      >
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="relative py-4">
              ...
              <div className="relative flex justify-center text-[10px] font-bold uppercase tracking-widest">
                <span className="bg-surface-container-low px-2 text-neutral-500">Ou continuar com</span>
              </div>
            </div>
            ...
            <div className="text-center">
              <Link to="/register" className="text-[10px] font-bold uppercase tracking-widest text-on-surface-variant hover:text-primary transition-colors">
                Novo operador? Registrar para acesso
              </Link>
            </div>
          </form>
        </div>
        ...
        <div className="mt-8 flex items-center justify-center gap-8 opacity-40">
          <div className="flex items-center gap-2">
            <Cpu size={14} />
            <span className="text-[10px] font-bold uppercase tracking-widest">Criptografia AES-256</span>
          </div>
          <div className="flex items-center gap-2">
            <Shield size={14} />
            <span className="text-[10px] font-bold uppercase tracking-widest">Resistente a Quantum</span>
          </div>
        </div>
      </motion.div>
    </div>
